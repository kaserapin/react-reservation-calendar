...
describe('Control panel component', () => {
    ...
    it('should have class "calendar-control-panel"', () => {
        const isClassNameCalendarControlPanel = root.findAllByType("div")[0].props.className.includes("calendar-control-panel");
        expect(isClassNameCalendarControlPanel).toBe(true);
    });

    it('should have "keyboard_arrow_left" icon name in leftArrow container', () => {
        const leftArrowContainer = root.findByProps({className: "arrow-left"});
    ...
    it('should have "keyboard_arrow_right" icon name in rightArrow container', () => {
        const rightArrowContainer = root.findByProps({className: "arrow-right"});
    ...
    it('should call props.onLeftArrowClick when the left arrow is clicked', () => {
        const leftArrowButton = root.findByProps({className: "arrow-left"});
    ...
    it('should call props.onRightArrowClick when the right arrow is clicked', () => {
        const rightArrowButton = root.findByProps({className: "arrow-right"});
